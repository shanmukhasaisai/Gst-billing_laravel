                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="phone_no" class="form-control border-bottom " id="validationCustom02" placeholder="Enter phone/mobile number" value="{{$party->phone_no}}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="address" class="form-control border-bottom " id="validationCustom02" placeholder="Enter Address" value="{{$party->address}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="account_holder_name" class="form-control border-bottom " id="validationCustom04" placeholder="Enter Accoumt Holder name" value="{{$party->account_holder_name}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="account_no" class="form-control border-bottom " id="validationCustom05" placeholder="Enter Account Number" value="{{$party->account_no}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="bank_name" class="form-control border-bottom " id="validationCustom02" placeholder="Enter Bank Name" value="{{$party->bank_name}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="ifsc_code" class="form-control border-bottom " id="validationCustom02" placeholder="Enter IFSC Code" value="{{$party->ifsc_code}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="branch_address" class="form-control border-bottom " id="validationCustom02" placeholder="Enter Branch Address" value="{{$party->branch_address}}">
                                </div>
                            </div>
                        </div>
